  ...
  return (
            ...
            <div key={titulo} className="flex flex-col sm:flex-row p-4 hover:border-neutral-400 transition delay-20 border-neutral-800 my-2 bg-neutral-900 border-1 rounded-xl">
                <div id="img" className="flex sm:justify-center sm:items-center">
                    <Image src={logo} width={logoW} height={logoH} className="block sm:mx-8 my-[0.5px] rounded-sm" alt="logo"/>
                </div>
                <div className="gap-0">
                    ...
                    <div className="flex sm:items-center flex-col sm:flex-row sm:gap-1">
                        ...
                        <p className="font-base text-sm landing-12 text-zinc-350">
                            {empresa}
                        </p>
                    </div>
                ...
                <p className="font-base text-sm landing-12 font">
                    {descricao}
                </p>
